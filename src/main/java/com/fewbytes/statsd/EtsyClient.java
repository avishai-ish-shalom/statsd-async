...
public class EtsyClient extends TimerTask {
    ...
    private static final Logger log = LoggerFactory.getLogger(EtsyClient.class);

    private final InetSocketAddress _address;
    private final DatagramChannel _channel;

    public EtsyClient(String host, int port) throws UnknownHostException, IOException {
        this(InetAddress.getByName(host), port);
    }

    public EtsyClient(InetAddress host, int port) throws IOException {
